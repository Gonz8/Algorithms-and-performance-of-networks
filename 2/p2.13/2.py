...
if __name__ == '__main__':
    ...
    now = t.time()
    # Computes the type of commercial route (provider, peer, customer, or unusable) plus the num of hops elected at every node to reach the destination
    elect_route(Network, destination, hops, route)
    deltat = t.time() - now
